...
Программа делает следующее:
  ...
  6. Вполняется внешний цикл с параметром.
     ...
     6.4. Выполняется внутренний цикл с параметром.
          ...
          6.4.4. Выполняется серия внутреннего цикла. Вычислется позиция и номер текущего символа для вывода на экран:
  ...
  7. На экран в 10 строку и 10 стодбец выводится вся строка.
